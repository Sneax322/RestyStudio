    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span className="font-black text-lg gradient-text">PaperCraft</span>
          <span className="font-light text-slate-500 dark:text-slate-400 text-sm hidden sm:inline">Studio</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/cart" className="relative w-9 h-9 rounded-xl flex items-center justify-center text-slate-600 hover:text-fuchsia-600 hover:bg-fuchsia-50 dark:text-slate-300 dark:hover:bg-slate-800 transition-all">
            ...
            {count > 0 && (
              <span className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-r from-fuchsia-500 to-violet-500 text-white text-xs font-bold rounded-full flex items-center justify-center animate-bounce">
                {count}
              </span>
            )}
          </Link>
